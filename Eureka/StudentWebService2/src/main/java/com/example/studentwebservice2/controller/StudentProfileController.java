package com.example.studentwebservice2.controller;

import com.example.studentwebservice2.entity.Student;
...
public class StudentProfileController {
    ...
    public String getStudentById(@PathVariable(value = "id")String id){
        return "Get student details from service 222 by id: " + id;
    }
